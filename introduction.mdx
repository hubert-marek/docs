...
<CardGroup cols={2}>
  <Card title="Templates" icon="copy" href="/core-concepts/environments">
  ...
  <Card title="Environments" icon="server" href="/core-concepts/environments">
    Environments are isolated, ephemeral copies of templates where your agents operate. **Each environment gets its own base API URL** that you can proxy to your agents.
  </Card>
