...
<Tip>
  **Lost? Look at Jupternootbook example:
  - [Diffs Demo](https://colab.research.google.com/drive/1-GZlU-wgAk0W2v8cpQuPP_UbCNJLmVk5?usp=sharing) - Capture agent actions as diffs
  - [Evaluations Demo](https://colab.research.google.com/drive/1cfeMQ2R_JpGRdagT0U-D8cngpsHJmJON?usp=sharing) - Run assertions against diffs
</Tip>
...
const client = new AgentDiff();  // Auto-loads from env vars
...
# (auto-loads base_url and token from env vars)
