...
<Tip>
  **Want to skip setup?** Copy one of the Jupternootebooks:
  - [Slack & Linear Diff Demo](https://colab.research.google.com/drive/1-GZlU-wgAk0W2v8cpQuPP_UbCNJLmVk5?usp=sharing) — Post messages, create issues, capture diffs
  - [Agent Evaluations Demo](https://colab.research.google.com/drive/1cfeMQ2R_JpGRdagT0U-D8cngpsHJmJON?usp=sharing) — Run the 40-task Linear benchmark
</Tip>
