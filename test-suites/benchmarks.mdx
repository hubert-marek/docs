...
<Tip>
  **Try it in Colab:**
  ...
  - [Evaluations Demo](https://colab.research.google.com/drive/1cfeMQ2R_JpGRdagT0U-D8cngpsHJmJON?usp=sharing) - Run assertions and scoring
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Integrate with Agents" icon="robot" href="/integrating-with-agents/openai-agents">
